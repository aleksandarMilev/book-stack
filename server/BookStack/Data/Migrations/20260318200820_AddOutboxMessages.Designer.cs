...
namespace BookStack.Data.Migrations
{
    ...
    [Migration("20260318200820_AddOutboxMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStack.Features.BookListings.Data.Models.BookListingDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BookStack.Features.Books.Data.Models.BookDbModel", b =>
                {
                    ...
                    b.HasIndex("NormalizedTitle", "NormalizedAuthor")
                        .IsUnique()
            ...
            modelBuilder.Entity("BookStack.Features.Orders.Data.Models.OrderDbModel", b =>
                {
                    ...
                    b.Property<string>("GuestPaymentTokenHash")
                        .HasMaxLength(64)
                    ...
                    b.Property<DateTime>("ReservationExpiresOnUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BookStack.Features.Orders.Data.Models.OrderItemDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("BookPublishedOn")
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("BookStack.Features.Payments.Data.Models.PaymentDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookStack.Features.Payments.Data.Models.PaymentWebhookEventDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookStack.Infrastructure.Outbox.Data.Models.OutboxMessageDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookStack.Features.BookListings.Data.Models.BookListingDbModel", b =>
                {
                    b.HasOne("BookStack.Features.Books.Data.Models.BookDbModel", "Book")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStack.Features.Orders.Data.Models.OrderItemDbModel", b =>
                {
                    ...
                    b.HasOne("BookStack.Features.BookListings.Data.Models.BookListingDbModel", "Listing")
                        .WithMany()
                        .HasForeignKey("ListingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BookStack.Features.Orders.Data.Models.OrderDbModel", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("BookStack.Features.Payments.Data.Models.PaymentWebhookEventDbModel", b =>
                {
                    ...
                    b.HasOne("BookStack.Features.Payments.Data.Models.PaymentDbModel", "Payment")
                        .WithMany()
